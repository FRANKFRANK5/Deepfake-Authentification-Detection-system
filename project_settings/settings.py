...
ALLOWED_HOSTS = ['detectify.onrender.com', 'localhost', '127.0.0.1']
...
if os.environ.get('DATABASE_URL'):
    try:
        ...
        pass  # Ikiwa dj_database_url haipo, tumia SQLite
...
IMAGE_ROOT = os.path.join(PROJECT_DIR, 'uploaded_images')
